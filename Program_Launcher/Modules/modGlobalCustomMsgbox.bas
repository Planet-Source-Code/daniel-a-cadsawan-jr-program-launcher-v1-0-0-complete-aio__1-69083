Attribute VB_Name = "modGlobalCustomMsgbox"
Option Explicit
...
Public sButtons() As String
Public lButton As Long
Public sHwnd As String

'Added by manavo11
Public lForecolor As Long
Public lBackcolor As Long

Public sDefaultButton As String
...
Public iButtonCount As Integer
Public iButtonWidth As Integer
'Added by manavo11
